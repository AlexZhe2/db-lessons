...
public class C3PODataSource {
    ...
    static {
        try {
            ...
            cpds.setJdbcUrl("jdbc:postgresql://localhost:5432/ifmo_lessons"); // строка подключения к бд
            cpds.setUser("ifmo"); // логин пользователя от бд
            cpds.setPassword("ifmo"); // пароль пользователя от бд
